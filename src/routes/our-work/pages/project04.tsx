                ...
                <div className="flex flex-col items-start gap-10">
                    <div className="h-full w-[300px] text-[15px] leading-loose">
                        <p className="text-justify font-bodycopy text-sm text-white leading-loose tracking-wider">
                            ...
                            user-centric designs, Marvel enabled the creation of
                            functional and interactive prototypes, and Ballpark
                            HQ facilitated usability testing with the general
                            public.
                        </p>
